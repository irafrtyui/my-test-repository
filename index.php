...
//   $date = explode(';', trim($item));
//   $product = ['name' => $date[0], 'price' => $date[1], 'weight' => $date[2]];
//   $products[] = $product;
//}
...
<table width="500px" border="1" cellpadding="5">
    ...
    <?php foreach ($pro as $v): ?>
        <tr>
            <td><img src="cards/<?php echo $v['image'] ?>" width="100px"</td><td><?php echo $v['name'] ?></td><td><?php echo '$' . $v['price'] ?></td><td><?php echo $v['weight']?></td><td><?php echo $v['vegan']?></td><td><?php echo implode(',', $v['property'])?></td>
        </tr>
    <?php endforeach; ?>
